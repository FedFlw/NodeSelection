...
python -m pow_so optimizer=so variant="rand" seed=85 strategy.d=20 strategy.ck=9
python -m pow_so optimizer=so variant="base" seed=85 strategy.d=20 strategy.ck=9
python -m pow_so optimizer=so variant="cpow" seed=85 strategy.d=20 strategy.ck=9
python -m pow_so optimizer=so variant="rpow" seed=85 strategy.d=20 strategy.ck=9
python -m pow_uo optimizer=uo variant="rand" seed=85 strategy.d=20 strategy.ck=9
python -m pow_uo optimizer=uo variant="base" seed=85 strategy.d=20 strategy.ck=9
python -m pow_uo optimizer=uo variant="cpow" seed=85 strategy.d=20 strategy.ck=9
python -m pow_uo optimizer=uo variant="rpow" seed=85 strategy.d=20 strategy.ck=9
python -m pow_rt optimizer=rt variant="rand" seed=85 strategy.d=20 strategy.ck=9
python -m pow_rt optimizer=rt variant="base" seed=85 strategy.d=20 strategy.ck=9
python -m pow_rt optimizer=rt variant="cpow" seed=85 strategy.d=20 strategy.ck=9
python -m pow_rt optimizer=rt variant="rpow" seed=85 strategy.d=20 strategy.ck=9
...
python -m pow_so optimizer=so variant="rand" seed=109 strategy.d=20 strategy.ck=9
python -m pow_so optimizer=so variant="base" seed=109 strategy.d=20 strategy.ck=9
python -m pow_so optimizer=so variant="cpow" seed=109 strategy.d=20 strategy.ck=9
python -m pow_so optimizer=so variant="rpow" seed=109 strategy.d=20 strategy.ck=9
python -m pow_uo optimizer=uo variant="rand" seed=109 strategy.d=20 strategy.ck=9
python -m pow_uo optimizer=uo variant="base" seed=109 strategy.d=20 strategy.ck=9
python -m pow_uo optimizer=uo variant="cpow" seed=109 strategy.d=20 strategy.ck=9
python -m pow_uo optimizer=uo variant="rpow" seed=109 strategy.d=20 strategy.ck=9
python -m pow_rt optimizer=rt variant="rand" seed=109 strategy.d=20 strategy.ck=9
python -m pow_rt optimizer=rt variant="base" seed=109 strategy.d=20 strategy.ck=9
python -m pow_rt optimizer=rt variant="cpow" seed=109 strategy.d=20 strategy.ck=9
python -m pow_rt optimizer=rt variant="rpow" seed=109 strategy.d=20 strategy.ck=9
...
python -m pow_so optimizer=so variant="rand" seed=663 strategy.d=20 strategy.ck=9
python -m pow_so optimizer=so variant="base" seed=663 strategy.d=20 strategy.ck=9
python -m pow_so optimizer=so variant="cpow" seed=663 strategy.d=20 strategy.ck=9
python -m pow_so optimizer=so variant="rpow" seed=663 strategy.d=20 strategy.ck=9
python -m pow_uo optimizer=uo variant="rand" seed=663 strategy.d=20 strategy.ck=9
python -m pow_uo optimizer=uo variant="base" seed=663 strategy.d=20 strategy.ck=9
python -m pow_uo optimizer=uo variant="cpow" seed=663 strategy.d=20 strategy.ck=9
python -m pow_uo optimizer=uo variant="rpow" seed=663 strategy.d=20 strategy.ck=9
python -m pow_rt optimizer=rt variant="rand" seed=663 strategy.d=20 strategy.ck=9
python -m pow_rt optimizer=rt variant="base" seed=663 strategy.d=20 strategy.ck=9
python -m pow_rt optimizer=rt variant="cpow" seed=663 strategy.d=20 strategy.ck=9
python -m pow_rt optimizer=rt variant="rpow" seed=663 strategy.d=20 strategy.ck=9
