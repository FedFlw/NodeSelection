...
def gen_client_fn(ips_mean: int, ips_var: int, num_clients: int, varying_config: Dict[str, float],
                  default_config: Dict[str, float], comp_time: int, samples_per_client: int, is_cnn: bool = False) -> \
